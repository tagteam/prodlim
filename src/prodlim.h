...
void prodlim_surv(double *y,int *status,double *weights,,double *time,double *nrisk,int *event,int *loss,double *surv,double *hazard,double *varhazard,int *reverse,int *t,int start,int stop);
